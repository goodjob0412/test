$(document).ready(function(){
	...
	$('.top_R > a:nth-child(1)').mouseenter(function(){
		$('.top_R > a:nth-child(1)').addClass('top_active')
	})
	$('.top_R > a:nth-child(1)').mouseleave(function(){
		$('.top_R > a:nth-child(1)').removeClass('top_active')
	})


	$('.top_R > a:nth-child(2)').mouseenter(function(){
		$('.top_R > a:nth-child(2)').addClass('top_active')
	})
	$('.top_R > a:nth-child(2)').mouseleave(function(){
		$('.top_R > a:nth-child(2)').removeClass('top_active')
	})


	$('.top_R > a:nth-child(3)').mouseenter(function(){
		$('.top_R > a:nth-child(3)').addClass('top_active')
	})
	$('.top_R > a:nth-child(3)').mouseleave(function(){
		$('.top_R > a:nth-child(3)').removeClass('top_active')
	})
