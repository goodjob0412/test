const ITEM_LIST = [
    // 로퍼
     [
        ...
        {item_no:10, covered_src: '25.png', src: '10.png', title:'내꺼 몰드창 니트메리 플랫', o_price:25300, color:'#fcbeb3,#77451c,#f83422'},
...
// 함수 시ㅏㄱ/////
function load_data(item_index,qty,item){
    ...
    // 인텍스 2
    //$('#tmp_sec_title').addClass('shoes_ul');
        ...
        for(let i=0; i<qty ; i++){
            ...
            let list=`
                ...
                <div class="${item_name[item_index]}_pro_img">
                        ...
                        <a href="index3.html?cate=${item_index}&item_no=${ITEM_LIST[item_index][i].item_no}">
    ...
    if(item_index == 0){
          let list =
          `
                <div class="${item_name[item_index]}_main">
                        <div class="${item_name[item_index]}_main_img">
                            <img src="img/index02/mainshoes01.png" alt="">
                            <span class="ment">신은 듯, 안신은 듯 가벼움!</span>
                            <p>로퍼의  <span>'新'</span> 세계 </p>
                                    
                        </div>
                </div>
                <div class="loafer_shoes_case">
                        <img src="img/index02/mainbanner_part2_1.png" alt="">
                        <img src="img/index02/mainbanner_part2_3.png" alt="">
                        <img src="img/index02/mainbanner_part2_2.png" alt="">
                        <span>NEW</span>
                </div>
          ` 
          
          $('.main_show').append(list)
    }
    else{
        let list =
          `
          <div class="boots_shoes_case">
                <img src="img/index02/mainbanner_part2_4.png" alt="">
                <img src="img/index02/mainbanner_part2_6.png" alt="">
                <img src="img/index02/mainbanner_part2_5.png" alt="">
                <span>NEW</span>
            </div>
                <div class="${item_name[item_index]}_main">
                        <div class="${item_name[item_index]}_main_img">
                            <img src="img/index02/mainshoes02.png" alt="">
                            <span class="ment">따뜻함과 가벼움의 정비례!</span>
                            <p>Compshou를  <span>꼭</span> 체험해보세요 </p>
        ...
        for(i=0; i<choose_color.length; i++) {
            ...
            `
                ...
                <div class="${item_name[color_index]}_pro_img">
                        ...
                        <a href="index3.html?cate=${color_index}&item_no=${ ITEM_LIST[color_index][ choose_color[i] ].item_no}">
