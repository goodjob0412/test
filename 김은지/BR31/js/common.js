...
// console.log(data[i])        
            list +=`    <div class="item_title"><a href="detail.html?cate_no=${cateNo}&item_no=${data[i].item_no}">${data[i].title}</a></div>`;
        ...
        if(sec_id == 'best') {
            ...
            list +=`    <a href="detail.html?cate_no=${cateNo}&item_no=${data[i].item_no}">`;
