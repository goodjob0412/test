...
for(let i=2; i<6; i++){
    if(c_no == i) {
        $('.detailbox_wrap').css({display: 'none'})
    ...
    if(size_chk) {
        ...
        let load_choose_opt = `<div class="choose_wrap">
                                    ...
                                    <div class="choose_box opt_qty">
                                        ...
                                        <div class="choose_box btn_close_box">
                                            <img class="btn_close btn_close1" src="./img/btn_close.png" alt="btn_close">
                                        </div>
                                    </div>
                                    <div class="choose_box item_price"><span>${tmp_price}</span>원</div>
                                </div>`
...
function handpack_out() {
    ...
    if(chk_result) {
        $('.handpack_opt_wrap').css({display: 'none'})
        $('.handpack_wrap').css({display: 'none'})
        // detail_height_minus()
    }
...
$('.flavor').click(function(){
    if($('.handpack_plus').length > 4){
        ...
        let load_handpack_plus =`<div class="choose_wrap handpack_wrap">
                                    <div class="choose_box handpack_plus">
                                        <span>(추가)</span>
                                        <span class="option_title2">${flavor_title}</span>
                                    </div>
                                    <div class="choose_box btn_close_box">
                                        <img class="btn_close btn_close2" src="./img/btn_close.png" alt="btn_close">
                                    </div>
                                </div>`;
